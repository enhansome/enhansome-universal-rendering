...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 141,960 | 🐛 3,660 | 🌐 JavaScript | 📅 2026-08-27 - The most popular SSR tool.
...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 141,960 | 🐛 3,660 | 🌐 JavaScript | 📅 2026-08-27 - Although primarily focused on SSR, Next.js can also generate static sites.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby#readme) ⭐ 55,941 | 🐛 437 | 🌐 JavaScript | 📅 2026-08-27 - SSG based on React and GraphQL.
...
* [Nuxt](https://github.com/nuxt/nuxt.js#readme) ⭐ 60,802 | 🐛 547 | 🌐 TypeScript | 📅 2026-08-27 - Similar to Next.js but for Vue.
* [Reframe](https://github.com/reframejs/reframe#readme) ⭐ 431 | 🐛 2 | 📅 2021-05-29 - Flexible web framework. It does SSR by default and can be used as SSG.
