...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,389 | 🐛 3,460 | 🌐 JavaScript | 📅 2026-09-20 - The most popular SSR tool.
...
* [Razzle](https://github.com/jaredpalmer/razzle#readme) ⭐ 11,020 | 🐛 135 | 🌐 JavaScript | 📅 2024-03-11 - Handles the building. You do the rest.
...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,389 | 🐛 3,460 | 🌐 JavaScript | 📅 2026-09-20 - Although primarily focused on SSR, Next.js can also generate static sites.
...
* [Nuxt](https://github.com/nuxt/nuxt.js#readme) ⭐ 60,881 | 🐛 479 | 🌐 TypeScript | 📅 2026-09-19 - Similar to Next.js but for Vue.
* [Reframe](https://github.com/reframejs/reframe#readme) ⭐ 430 | 🐛 2 | 📅 2021-05-29 - Flexible web framework. It does SSR by default and can be used as SSG.
