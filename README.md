...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,230 | 🐛 3,339 | 🌐 JavaScript | 📅 2026-09-11 - The most popular SSR tool.
...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,230 | 🐛 3,339 | 🌐 JavaScript | 📅 2026-09-11 - Although primarily focused on SSR, Next.js can also generate static sites.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby#readme) ⭐ 55,939 | 🐛 445 | 🌐 JavaScript | 📅 2026-09-11 - SSG based on React and GraphQL.
...
* [Nuxt](https://github.com/nuxt/nuxt.js#readme) ⭐ 60,841 | 🐛 475 | 🌐 TypeScript | 📅 2026-09-10 - Similar to Next.js but for Vue.
* [Reframe](https://github.com/reframejs/reframe#readme) ⭐ 430 | 🐛 2 | 📅 2021-05-29 - Flexible web framework. It does SSR by default and can be used as SSG.
