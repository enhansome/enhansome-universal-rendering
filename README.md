...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 141,873 | 🐛 4,052 | 🌐 JavaScript | 📅 2026-08-20 - The most popular SSR tool.
...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 141,873 | 🐛 4,052 | 🌐 JavaScript | 📅 2026-08-20 - Although primarily focused on SSR, Next.js can also generate static sites.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby#readme) ⭐ 55,941 | 🐛 422 | 🌐 JavaScript | 📅 2026-08-19 - SSG based on React and GraphQL.
...
* [Nuxt](https://github.com/nuxt/nuxt.js#readme) ⭐ 60,764 | 🐛 537 | 🌐 TypeScript | 📅 2026-08-19 - Similar to Next.js but for Vue.
* [Reframe](https://github.com/reframejs/reframe#readme) ⭐ 431 | 🐛 2 | 📅 2021-05-29 - Flexible web framework. It does SSR by default and can be used as SSG.
