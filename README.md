...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,432 | 🐛 3,480 | 🌐 JavaScript | 📅 2026-09-25 - The most popular SSR tool.
...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,432 | 🐛 3,480 | 🌐 JavaScript | 📅 2026-09-25 - Although primarily focused on SSR, Next.js can also generate static sites.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby#readme) ⭐ 55,943 | 🐛 449 | 🌐 JavaScript | 📅 2026-09-24 - SSG based on React and GraphQL.
* [React Static](https://github.com/nozzle/react-static#readme) ⭐ 10,341 | 🐛 1 | 🌐 JavaScript | 📅 2022-10-31 - SSG based on React and focused on simplicity.
...
* [Nuxt](https://github.com/nuxt/nuxt.js#readme) ⭐ 60,904 | 🐛 481 | 🌐 TypeScript | 📅 2026-09-25 - Similar to Next.js but for Vue.
* [Reframe](https://github.com/reframejs/reframe#readme) ⭐ 430 | 🐛 2 | 📅 2021-05-29 - Flexible web framework. It does SSR by default and can be used as SSG.
