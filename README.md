...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,315 | 🐛 3,362 | 🌐 JavaScript | 📅 2026-09-15 - The most popular SSR tool.
...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,315 | 🐛 3,362 | 🌐 JavaScript | 📅 2026-09-15 - Although primarily focused on SSR, Next.js can also generate static sites.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby#readme) ⭐ 55,939 | 🐛 450 | 🌐 JavaScript | 📅 2026-09-14 - SSG based on React and GraphQL.
...
* [Nuxt](https://github.com/nuxt/nuxt.js#readme) ⭐ 60,863 | 🐛 480 | 🌐 TypeScript | 📅 2026-09-15 - Similar to Next.js but for Vue.
* [Reframe](https://github.com/reframejs/reframe#readme) ⭐ 430 | 🐛 2 | 📅 2021-05-29 - Flexible web framework. It does SSR by default and can be used as SSG.
