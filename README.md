...
# Awesome Universal Rendering with stars
...
* **Render to HTML via headless browser** <br/>
...
* **Server-Side Rendering (SSR)** <br/>
  ...
  Every time a user requests a page, the server renders the page directly to HTML. <br/>
...
* **Static Site Generators (SSG)** <br/>
  ...
  When your website is built, each page is rendered to a HTML file that includes your page's content. <br/>
...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,397 | 🐛 3,471 | 🌐 JavaScript | 📅 2026-09-22 - The most popular SSR tool.
...
* [Razzle](https://github.com/jaredpalmer/razzle#readme) ⭐ 11,019 | 🐛 135 | 🌐 JavaScript | 📅 2024-03-11 - Handles the building. You do the rest.
...
* [Next.js](https://github.com/zeit/next.js#readme) ⭐ 142,397 | 🐛 3,471 | 🌐 JavaScript | 📅 2026-09-22 - Although primarily focused on SSR, Next.js can also generate static sites.
* [Gatsby.js](https://github.com/gatsbyjs/gatsby#readme) ⭐ 55,939 | 🐛 450 | 🌐 JavaScript | 📅 2026-09-19 - SSG based on React and GraphQL.
* [React Static](https://github.com/nozzle/react-static#readme) ⭐ 10,344 | 🐛 1 | 🌐 JavaScript | 📅 2022-10-31 - SSG based on React and focused on simplicity.
...
* [react-snap](https://github.com/stereobooster/react-snap#readme) ⭐ 5,119 | 🐛 192 | 🌐 JavaScript | 📅 2026-02-02 - Uses Puppeteer to crawl & render your pages.
* [React Snapshot](https://github.com/geelen/react-snapshot#readme) ⭐ 1,654 | 🐛 68 | 🌐 JavaScript | 📅 2021-05-12 - Pre-renders React apps at build-time. Uses `require('react-dom/server').renderToString` to directly render the HTML. Uses JSDOM as headless browser to automatically discover your app's URLs.
* [SSG webpack plugin](https://github.com/markdalgleish/static-site-generator-webpack-plugin#readme) ⭐ 1,600 | 🐛 45 | 🌐 JavaScript | 📅 2018-12-28 - Directly render your pages to HTML. You provide render functions and routes. All routes are rendered at build-time using the render functions you provided. Also has a crawl mode to use a headless browser to automatically discover your website's URLs.
...
* [Nuxt](https://github.com/nuxt/nuxt.js#readme) ⭐ 60,893 | 🐛 471 | 🌐 TypeScript | 📅 2026-09-22 - Similar to Next.js but for Vue.
* [Reframe](https://github.com/reframejs/reframe#readme) ⭐ 430 | 🐛 2 | 📅 2021-05-29 - Flexible web framework. It does SSR by default and can be used as SSG.
...
* [Angular Universal](https://github.com/angular/universal#readme) ⚠️ Archived - Official packages for SSR with Angular.
